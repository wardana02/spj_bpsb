        ...
        <section class="content">
          <div class="box col-sm-12">
            ...
            <br>
              ...
              <form class="form-horizontal" action="<?php echo base_url("Pegawai/run_edit");?>" method="post" enctype="multipart/form-data">
    
    <div class="form-group">
        <label class="col-lg-2 control-label">No Register</label>
        <div class="col-lg-10">
            <input type="text" name="id_pegawai" class="form-control" value="<?php echo $data->id_pegawai ;?>" readonly="readonly">
        </div>
    </div>
    ...
    <div class="form-group">
              ...
              <div class="col-lg-10">
                  <input type="text" name="nip_pegawai" class="form-control" value="<?php echo $data->nip_pegawai ;?>" placeholder="Nomor Induk Pegawai" required>
              </div>
          </div>
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                  <input type="text" name="nama_pegawai" class="form-control" value="<?php echo $data->nama_pegawai ;?>" placeholder="Nama Pegawai" required>
              </div>
          </div>
                        ...
                        <select class="form-control" name="golongan">
                            <?php
                              foreach($golongan as $gol){
                                 ...
                                 if ($data->golongan == $gol->id_golongan){
                                echo "selected";
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                  <input type="text" name="gaji_pokok" class="form-control" value="<?php echo $data->gaji_pokok ;?>" placeholder="Gaji Pokok Perjalanan Pegawai" required>
              </div>
          </div>
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                  <input type="text" name="gol_perjalanan" class="form-control" value="<?php echo $data->gol_perjalanan ;?>" placeholder="Golongan Perjalanan Pegawai" required>
              </div>
          </div>
