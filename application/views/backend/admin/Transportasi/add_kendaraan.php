        ...
        <section class="content">
          <div class="box col-sm-12">
            ...
            <br>
              ...
              <form class="form-horizontal" action="<?php echo base_url("transportasi/run_save");?>" method="post" enctype="multipart/form-data">
    <div class="form-group">
        <label class="col-lg-2 control-label">No Register</label>
        <div class="col-lg-10">
            <input type="text" name="id_kendaraan" class="form-control" value='TRS<?php echo date('His')?>' readonly="readonly">
        </div>
    </div>
          <div class="form-group">
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                  <input type="text" name="bahan_bakar" class="form-control" placeholder="Jenis Bahan Bakar" required>
              </div>
          </div>
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                  <input type="text" name="jenis_pembiayaan" class="form-control" placeholder="Jenis Pembiayaan" required>
              </div>
          </div>
